...
namespace Confuser.Core {
	...
	public abstract class Packer : ConfuserComponent {
		...
		public static void ProtectStub(ConfuserContext context, string fileName, byte[] module, StrongNameKey snKey, Protection prot = null) {
	...
	internal class PackerLogger : ILogger {
		...
		public void LogFormat(string format, params object[] args) {
			baseLogger.LogFormat(format, args);
		}
		...
		public void Finish(bool successful) {
			...
			baseLogger.Log("Finish protecting packer stub.");
		}
	}
